...
import 'package:meu_app/screens/apresBasquete.dart';
import 'package:google_fonts/google_fonts.dart';

class Apresvolei extends StatelessWidget {
  const Apresvolei({super.key});

  void _goToApresentacao(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const Apresbasquete()), // Nome correto da classe
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFFD950),
      body: SafeArea(
        child: Column(
            ...
            Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'União de agilidade, precisão e estratégia.\n O trabalho em equipe é a chave\n para vencer cada ponto.',
                    style: GoogleFonts.righteous(
                      fontSize: 18,
